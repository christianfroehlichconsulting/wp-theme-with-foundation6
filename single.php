...
<div class="row">
	...
	<?php while ( have_posts() ) : the_post(); ?>
		<article <?php post_class() ?> id="post-<?php the_ID(); ?>">
			...
			<?php do_action( 'cfcdesignsystem_post_before_entry_content' ); ?>
			...
			<?php do_action( 'cfcdesignsystem_post_before_comments' ); ?>
			<?php comments_template(); ?>
			<?php do_action( 'cfcdesignsystem_post_after_comments' ); ?>
		</article>
	<?php endwhile;?>
