 ...
 */
if ( ! function_exists( 'cfcdesignsystem_top_bar_l' ) ) {
	function cfcdesignsystem_top_bar_l() {
	    wp_nav_menu(array(
	        ...
	        'walker' => new CFCdesignsystem_Top_Bar_Walker(),
	    ));
	}
}
 ...
 * Right top bar
 */
if ( ! function_exists( 'cfcdesignsystem_top_bar_r' ) ) {
	function cfcdesignsystem_top_bar_r() {
	    wp_nav_menu(array(
	        'container' => false,                           // Remove nav container
	        'container_class' => '',                        // Class of container
	        'menu' => '',                                   // Menu name
 ...
 * Mobile off-canvas
 */
if ( ! function_exists( 'cfcdesignsystem_mobile_off_canvas' ) ) {
	function cfcdesignsystem_mobile_off_canvas( $direction = 'left' ) {
	    wp_nav_menu(array(
	        'container' => false,                           // Remove nav container
	        'container_class' => '',                        // Class of container
	        'menu' => '',                                   // Menu name
	        ...
	        'depth' => 5,                                   // Limit the depth of the nav
	        'fallback_cb' => false,                         // Fallback function (see below)
	        'walker' => new CFCdesignsystem_Offcanvas_Walker($direction),
	    ));
	}
}
...
*/
if ( ! function_exists( 'cfcdesignsystem_add_menuclass' ) ) {
	function cfcdesignsystem_add_menuclass( $ulclass ) {
	    $find = array('/<a rel="button"/', '/<a title=".*?" rel="button"/');
	    $replace = array('<a rel="button" class="button"', '<a rel="button" class="button"');

	    return preg_replace( $find, $replace, $ulclass, 1 );
	}
	add_filter( 'wp_nav_menu','cfcdesignsystem_add_menuclass' );
}
...
if ( ! function_exists( 'cfcdesignsystem_breadcrumb' ) ) {
    function cfcdesignsystem_breadcrumb( $showhome = true, $separatorclass = false ) {
