...
function wpt_register_theme_customizer( $wp_customize ) {
	...
	$wp_customize->add_panel( 'mobile_menu_settings', array(
	  'priority' => 1000,
	  'theme_supports' => '',
	  'title' => __( 'Mobile Menu Settings', 'cfcdesignsystem' ),
	  'description' => __( 'Controls the mobile menu', 'cfcdesignsystem' ),
	) );

	// Create custom field for mobile navigation layout
	$wp_customize->add_section( 'mobile_menu_layout' , array(
		'title'	=> __('Mobile navigation layout','cfcdesignsystem'),
	...
	$wp_customize->add_section( 'mobile_menu_position' , array(
		'title'	=> __('Mobile navigation position','cfcdesignsystem'),
		'panel' => 'mobile_menu_settings',
		'priority' => 1001,
	));
	...
	$wp_customize->add_setting(
		...
		array(
			'default'	=> __( 'offcanvas', 'cfcdesignsystem' ),
		)
	);
	...
	$wp_customize->add_setting(
		...
		array(
			'default'	=> __( 'left', 'cfcdesignsystem' ),
		)
	);
