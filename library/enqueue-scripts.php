...
if ( ! function_exists( 'cfcdesignsystem_scripts' ) ) :
	...
	// wp_enqueue_script( 'jquery', get_template_directory_uri() . '/dist/assets/javascript/vendor/jquery.js', array(), '2.1.4', false );
