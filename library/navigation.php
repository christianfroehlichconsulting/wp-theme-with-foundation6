 ...
 */
if ( ! function_exists( 'cfcdesignsystem_mobile_nav' ) ) {
	function cfcdesignsystem_mobile_nav() {
	    wp_nav_menu(array(
        'container' => false,                           // Remove nav container
				'menu'           => __( 'mobile-nav', 'cfcdesignsystem' ),
				'menu_class'     => 'vertical menu',
				'theme_location' => 'mobile-nav',
				'items_wrap'     => '<ul id="%1$s" class="%2$s show-for-small-only" data-accordion-menu>%3$s</ul>',
				'fallback_cb'    => false,
        'walker' => new CFCdesignsystem_Mobile_Walker(),
	    ));
	}
}
