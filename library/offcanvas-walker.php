...
if ( ! class_exists( 'CFCdesignsystem_Offcanvas_Walker' ) ) :
class CFCdesignsystem_Offcanvas_Walker extends Walker_Nav_Menu {
	...
	function start_lvl( &$output, $depth = 0, $args = array() ) {
		$output .= "\n<ul class=\"{$this->direction}-submenu\">\n<li class=\"back\"><a href=\"#\">". __( 'Back', 'cfcdesignsystem' ) ."</a></li>\n";
	}
}
endif;
?>
