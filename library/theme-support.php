...
if ( ! function_exists( 'cfcdesignsystem_theme_support' ) ) :
function cfcdesignsystem_theme_support() {
	// Add language support
	load_theme_textdomain( 'cfcdesignsystem', get_template_directory() . '/languages' );
